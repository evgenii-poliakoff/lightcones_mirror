...
from fastmul import fastmul
from _dlancz import dlancz
...
def is_sparse_matrix(a):
    if isinstance(a, (scipy.sparse.csr_matrix, scipy.sparse.csc_matrix, scipy.sparse.coo_matrix)):
        return True
